...
describe('DbAddAccount UseCase', () => {
  ...
  test('Garante que erros do DBAccotunt não sejam tratados e sejam repassados', async () => {
    const { sut, addAccountRepositoryStub } = makeSut()
  ...
  test('Garante que uma conta seja retornada se os parametros corretos forem enviados', async () => {
    const { sut } = makeSut()
    const accountData = {
      name: 'valid_name',
      email: 'valid_email',
